...
class DashboardWidget extends BaseModel
{
    ...
    const WIDGETS = [
        ...
        ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'todays_follow_ups',  'status' => 1],
        ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'upcoming_follow_ups',  'status' => 1],
        ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'pending_calls_meetings',  'status' => 1],
