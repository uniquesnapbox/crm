<div class="ml-auto d-flex align-items-center">
    ...
    <div class="more-filters py-2 pl-0 pl-lg-2 pl-md-2 position-relative">
        ...
        <a href="javascript:;" class="js-open-more-filter mb-0 d-none d-lg-block  f-14 text-dark-grey"><i
                class="fa fa-filter f-13 text-dark-grey mt-1 mr-1"></i>@lang('app.moreFilters')</a>

        <a href="javascript:;" class="js-open-more-filter mb-0 d-block d-lg-none  text-dark-grey"><i
        ...
        <div class="more-filter-tab" id="more_filter">
            <div class="filter-inner">
                <div class="sticky-top bg-white">
                    ...
                    <button type="button" class="close js-close-more-filter" aria-label="Close">
...
@once
    @push('scripts')
        <script>
            $('body').on('click', '.more-filters .js-open-more-filter', function(e) {
                e.preventDefault();
                $(this).closest('.more-filters').find('.more-filter-tab').addClass('in');
            });

            $('body').on('click', '.more-filters .js-close-more-filter', function(e) {
                e.preventDefault();
                $(this).closest('.more-filter-tab').removeClass('in');
            });
        </script>
    @endpush
@endonce
